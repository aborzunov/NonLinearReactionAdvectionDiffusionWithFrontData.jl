@testset "Якобиан сопряженной задачи в трехдиагональном виде." begin
    ...
    # TODO: сигнатура adjoint_RP изменилась
    # jac = NonLinearReactionAdvectionDiffusionWithFrontData.∂adjointRP_∂y(y, 1, Xₙ, N, Tₘ, M, ε, ulₘ, urₘ, qq, U, f1_data, f2_data)
    @test_broken isapprox(tdjac, jac)
